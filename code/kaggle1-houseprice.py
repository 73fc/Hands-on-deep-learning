...
#---------------------------------------数据读取--------------------------------
train_data = pd.read_csv(r'e:/算法刷题/动手学深度学习/data/house/train.csv')
test_data = pd.read_csv(r'e:/算法刷题/动手学深度学习/data/house/test.csv')


#查看信息
train_data.shape, test_data.shape
train_data.iloc[:4,[0,1,3,-3,-2,-1]]
...
def train( net, train_features, train_labels, test_features, test_labels, num_epochs,
    ...
    for _ in range(num_epochs):
        ...
        temp = log_rmse(net,train_features,train_labels)
...
k, num_epochs, lr, weight_decay, batch_size = 5, 80, 0.01, 0.15, 64
