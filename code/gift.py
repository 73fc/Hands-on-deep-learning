...
import time
d2l.set_figsize()
content_img = image.imread('cw.jpg')
...
ctx, image_shape = d2l.try_gpu(), (450, 600)
...
d2l.plt.imsave('neural-style-11.png', postprocess(output).asnumpy())

image_shape = (450, 600)
_, content_Y = get_contents(image_shape, ctx)
_, style_Y = get_styles(image_shape, ctx)
X = preprocess(postprocess(output) * 255, image_shape)
output = train(X, content_Y, style_Y, ctx, 0.01, 500, 100)
